...
class MainLayoutCubit extends Cubit<bool> {
  MainLayoutCubit() : super(false);
...
class MainLayout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: _MainLayoutContent(child: child),
    );
  }
}
...
class _MainLayoutContent extends StatelessWidget {
  ...
  const _MainLayoutContent({super.key, required this.child});
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<MainLayoutCubit, bool>(
            ...
            drawer: isDesktop
                ...
                : Theme(
                    ...
                    child: Drawer(
                      backgroundColor: Colors.transparent,
                      elevation: 0,
                      child: _buildSidebar(context, false, location), // Mobile sidebar is never collapsed (shows text)
                    ),
                  ),
            body: Row(
              children: [
                ...
                if (isDesktop)
                  AnimatedContainer(
                    ...
                    child: _buildSidebar(context, isSidebarCollapsed, location),
                  ),
                // Main Content Area
                Expanded(
                  child: Column(
                              ...
                              children: [
                                ...
                                Builder(
                                  builder: (context) => IconButton(
                                    ...
                                    onPressed: () {
                                      if (isDesktop) {
                                        context.read<MainLayoutCubit>().toggleSidebar();
                                      } else {
  ...
  Widget _buildSidebar(BuildContext context, bool isCollapsed, String location) {

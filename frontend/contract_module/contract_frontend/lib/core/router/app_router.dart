...
import 'package:sasheco_dashboard_web/features/contracts/presentation/screens/contract_templates_screen.dart';
import 'package:sasheco_dashboard_web/features/launcher/presentation/screens/apps_launcher_screen.dart';
...
GoRouter createAppRouter(AuthCubit authCubit) {
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: '/apps',
        builder: (context, state) => const AppsLauncherScreen(),
      ),
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(
            ...
            builder: (context, state) {
              ...
              return const ContractTemplatesScreen();
            },
          ),
          GoRoute(
            path: '/create-user',
